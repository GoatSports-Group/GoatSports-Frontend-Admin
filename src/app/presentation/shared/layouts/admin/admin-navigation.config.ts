...
export const VENUE_OWNER_NAVIGATION: readonly AdminNavigationItem[] = [
  ...
  { title: 'Quản lý cơ sở', description: 'Thông tin, hình ảnh và tiện ích cơ sở', icon: 'land-plot', route: '/venues', developing: true },
  { title: 'Sân thi đấu', description: 'Quản lý từng sân con và trạng thái vận hành', icon: 'activity', route: '/courts', developing: true },
  { title: 'Lịch và bảng giá', description: 'Khung giờ, ngày nghỉ và quy tắc giá', icon: 'calendar', route: '/schedule', developing: true },
  { title: 'Đơn đặt sân', description: 'Theo dõi đơn thuộc cơ sở của bạn', icon: 'file-text', route: '/owner-bookings', developing: true },
